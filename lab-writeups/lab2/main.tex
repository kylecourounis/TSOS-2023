...
\title{	
   ...
   \huge{Lab 2 - Operating Systems}\\     	               % Assignment title
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{enumerate}
\item The console in our project is similar to the Linux TTY in that we use a TypeScript file (represents the device file) that captures the keyboard events and then writes to the screen and a buffer. Also, in our terminal, the letters are drawn separately from what is being put into the buffer for execution, so they are not actually intertwined and really just mirror each other. 
\end{enumerate}
\end{document}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
