...
module TSOS {
    ...
    export class Cpu {
            ...
            switch (this.IR) {
                ...
                case OpCode.SYS: {
                    if (this.Xreg === 1) {
                        ...
                        _KernelInterruptQueue.enqueue(new Interrupt(SYS_PRINT_STR, [_MemAccessor.getMDR()]));
                    }
        ...
        public cycle(): void {
            ...
            console.log(`IR: ${Utils.toHex(this.IR, 2)}, Acc: ${Utils.toHex(this.Acc, 2)}, xReg: ${Utils.toHex(this.Xreg, 2)}, yReg: ${Utils.toHex(this.Yreg, 2)}`);
